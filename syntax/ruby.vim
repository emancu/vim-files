...
" not Ruby, but I put it here for convenience or ignorance.
...
if !exists("ruby_no_special_methods")
  ...
  syn keyword rubyAccess    module_functions
...
if version >= 508 || !exists("did_ruby_syntax_inits")
  ...
  HiLink rubyClassVariable		PreProc
  ...
  HiLink rubyInstanceVariable		PreProc
