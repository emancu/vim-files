...
call IMAP('should-', "should \"<++>\" do\r  <++>\r\bend", 'ruby')
call IMAP('test-', "test \"<++>\" do\r  <++>\r\bend", 'ruby')
call IMAP('setup-', "setup do\r  <++>\r\bend", 'ruby')
call IMAP('teardown-', "teardown do\r  <++>\r\bend", 'ruby')
